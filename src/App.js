...
const eRechnungMappingData = [
    ...
    { id: 40, btId: 'BT-42', en16931: 'Seller contact telephone number', description: 'Telefon des Verkäufers', xrechnungPath: '.../Contact/cbc:Telephone', zugferdPath: '.../ram:DefinedTradeContact/ram:TelephoneUniversalCommunication/ram:CompleteNumber', mandatory: true, formats: ['XRechnung', 'ZUGFeRD'] },
    { id: 41, btId: 'BT-43', en16931: 'Seller contact email address', description: 'E-Mail des Verkäufers', xrechnungPath: '.../Contact/cbc:ElectronicMail', zugferdPath: '.../ram:DefinedTradeContact/ram:EmailURIUniversalCommunication/ram:URIID', mandatory: true, formats: ['XRechnung', 'ZUGFeRD'] },
...
const formatRequirements = {
    'XRechnung': {
        ...
        mandatory: [
            ...
            'BT-27', 'BT-31', 'BT-34', 'BT-35', 'BT-37', 'BT-38', 'BT-40', 'BT-41', 'BT-42', 'BT-43', // Verkäufer
